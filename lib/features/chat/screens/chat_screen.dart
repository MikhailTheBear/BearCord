...
class _ChatScreenState extends ConsumerState<ChatScreen> {
        ...
        return _ConfirmDialog(
          ...
          onConfirm: () async {
            ...
            try {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content: Text('Переписка очищена'),
  ...
  Widget build(BuildContext context) {
    ...
    // Когда первоначальная загрузка закончилась,
    // прокручиваем чат вниз.
    if (_wasLoading && !chatState.isLoading) {
    ...
    _wasLoading = chatState.isLoading;
            ...
            child: Column(
              children: [
                ...
                MessageInput(
                  ...
                  // sendMessage('📎 Файл')
                  //
                  // Из-за этого сервер получал обычный text.
                  //
                  // Теперь реально отправляем файл.
                  onSendFile: (filePath) {
                    ref
                        .read(
                      chatProvider(
