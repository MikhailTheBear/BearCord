...
// Это позволяет не запускать loadMessages()
// во время обычного скролла.
}
...
// Обновляем сообщения только после возвращения
// приложения из background.
ref
    .read(
...
// Во время загрузки ничего не запускаем.
...
// Сообщение и его содержимое уже синхронизированы.
